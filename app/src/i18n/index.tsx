...
const STRINGS = {
  ...
  "club.lexicon": { hr: "Leksikon pairinga", en: "Pairing language lexicon" },
  "club.lexiconTeaser": {
  ...
  "club.dictionaryCatPairing": { hr: "Pairing", en: "Pairing" },
  ...
  "club.archetypesTeaser": {
    hr: "Šest stilskih eseja o večernjem pairingu: od suhoće Connecticuta i amontillada do espressa uz kratku vitolu.",
  ...
  "filter.wrapper": { hr: "Wrapper", en: "Wrapper" },
  "filter.binder": { hr: "Binder", en: "Binder" },
  "filter.filler": { hr: "Filler", en: "Filler" },
  "filter.puro": { hr: "Samo puro", en: "Puro only" },
  "leaf.wrapper": { hr: "Wrapper", en: "Wrapper" },
  "leaf.binder": { hr: "Binder", en: "Binder" },
  "leaf.filler": { hr: "Filler", en: "Filler" },
