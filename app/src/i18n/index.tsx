...
const STRINGS = {
  ...
  "nav.shopping": { hr: "Shopping", en: "Shopping" },
  // pairing
  ...
  "shop.legalNote": { hr: "Online prodaja duhana u HR nije dozvoljena — cijene cigara su referentne, kupnja u dućanu.", en: "Online tobacco sales are not allowed in Croatia — cigar prices are reference only, buy in store." },
  // filteri
