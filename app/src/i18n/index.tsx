...
const STRINGS = {
  ...
  "ocr.workingPaddle": { hr: "PaddleOCR (u pregledniku)…", en: "PaddleOCR (in browser)…" },
  ...
  "ocr.error": { hr: "Prepoznavanje nije uspjelo — prvi put treba mreža za modele.", en: "Recognition failed — first use needs network for models." },
