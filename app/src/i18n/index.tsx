...
const STRINGS = {
  ...
  "session.date": { hr: "Datum", en: "Date" },
  "session.time": { hr: "Vrijeme", en: "Time" },
  "session.datePast": {
    hr: "Zapis ide na odabrani dan, ne na današnji.",
    en: "The entry lands on the chosen day, not today.",
  },
  "wish.lastTitle": { hr: "Zadnja iz humidora", en: "Last one in the humidor" },
  "wish.lastBody": {
    hr: "Ovo je bila zadnja — u humidoru je više nema. Da je stavim na listu želja, da je vidiš kod kupnje?",
    en: "That was the last one — none left in your humidor. Add it to the wishlist so it shows up when you shop?",
  },
  ...
  "coll.editDate": { hr: "Promijeni datum", en: "Change the date" },
