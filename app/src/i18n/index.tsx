...
const STRINGS = {
  ...
  "shop.wishlistEmpty": { hr: "Lista želja je prazna — označi boce i cigare zvjezdicom (☆) na njihovim karticama i ovdje će se pojaviti s cijenama.", en: "Your wishlist is empty — star (☆) bottles and cigars on their cards and they will appear here with prices." },
  "shop.total": { hr: "Ukupno", en: "Total" },
  "shop.share": { hr: "Podijeli / kopiraj", en: "Share / copy" },
  "shop.copied": { hr: "Kopirano", en: "Copied" },
  "shop.gaps": { hr: "Rupe u kolekciji", en: "Collection gaps" },
  "shop.gapsHint": { hr: "Segmenti u kojima još nemaš nijednu bocu, s prijedlogom za popuniti — živi plan koji prati što označiš kao \"Imam\".", en: "Segments where you own nothing yet, with a pick to fill each — a live plan that follows what you mark as owned." },
  "shop.gapsDone": { hr: "Svi segmenti pokriveni — kolekcija ima kompletan presjek. 🥃", en: "Every segment covered — your collection spans the full spectrum. 🥃" },
  "shop.segments": { hr: "Preporuke po segmentu", en: "Picks by segment" },
  "shop.pickTop": { hr: "Vrh ponude", en: "Top shelf" },
  "shop.pickValue": { hr: "Najbolji omjer", en: "Best value" },
  "shop.pickBudget": { hr: "Pristupačno (do 30 €)", en: "Budget (under €30)" },
  "shop.buffet": { hr: "Buffet petorka", en: "The buffet five" },
  "shop.buffetHint": { hr: "Pet boca koje daju najbolji presjek kategorije — po jedna iz svakog segmenta, birano po omjeru kvalitete i cijene. Boce koje već imaš se preskaču.", en: "Five bottles giving the best cross-section of the category — one per segment, picked by quality-to-price ratio. Bottles you own are skipped." },
