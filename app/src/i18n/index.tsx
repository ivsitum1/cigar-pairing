...
const STRINGS = {
  ...
  "club.hrGuideTeaser": {
    hr: "Praktičan vodič za kupnju u Hrvatskoj: duhan, pića, cijene, linkovi, prvi kit, zaliha i pokloni.",
  ...
  "club.hrGuideSubtitle": { hr: "Lokalna kupovna pravila", en: "Local buying rules" },
  ...
  "club.archetypesTeaser": {
    hr: "Šest stilskih eseja za večernji pairing: od Connecticut i amontillado suhoće do espressa i kratke vitole.",
  ...
  "session.title": { hr: "Večernji pairing", en: "Evening pairing" },
  "session.hint": {
  ...
  "shops.intro": {
    hr: "Gdje kupiti po regiji. HR trgovine imaju izravne linkove na proizvod gdje postoje; EU/USA vode na pretragu po nazivu.",
