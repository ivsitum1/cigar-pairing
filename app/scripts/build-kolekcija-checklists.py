...
DRINK_CHECKLISTS: list[dict] = [
    ...
    },
    {
        ...
        "tiers": [
            ...
            ("3", "HR crveno", "Teran / Plavac / Babić", "Lokalni pairing", "HR"),
            ("4", "Tokaj / Sauternes", "Aszú / Sauternes", "Desert uz blagi maduro", "vinoteka"),
            ("4", "Madeira / Prošek", "Bual / Malmsey / Tomić", "Oksidativni desert", "vinoteka"),
        ],
        "guide": [
