# -*- coding: utf-8 -*-
"""Scrape gin catalog from allez.hr + ecuga.com.

Output: app/scripts/output/gin_catalog_raw.json

Pokretanje: python scripts/scrape-gin-catalog.py
            python scripts/scrape-gin-catalog.py --allez-only
"""
...
from gin_shared import ALLEZ_LISTS, ECUGA_CATEGORIES, format_price_eur

ROOT = Path(__file__).resolve().parent.parent
OUT_DIR = Path(__file__).resolve().parent / "output"
OUT_JSON = OUT_DIR / "gin_catalog_raw.json"
...
def scrape_ecuga() -> list[dict]:
    ...
    with sync_playwright() as p:
        ...
        page.goto(f"{bases[0]}/gin", wait_until="domcontentloaded", timeout=60000)
