# -*- coding: utf-8 -*-
"""Scrape tequila/mezcal catalog from allez.hr + ecuga.com.

Output: app/scripts/output/tequila_catalog_raw.json

Pokretanje: python scripts/scrape-tequila-catalog.py
            python scripts/scrape-tequila-catalog.py --allez-only
"""
...
from tequila_shared import ALLEZ_LISTS, ECUGA_CATEGORIES, format_price_eur

ROOT = Path(__file__).resolve().parent.parent
OUT_DIR = Path(__file__).resolve().parent / "output"
OUT_JSON = OUT_DIR / "tequila_catalog_raw.json"
...
def scrape_ecuga() -> list[dict]:
    ...
    bases = [
        "https://ecuga.com/katalog/spirits-and-liqueurs",
        "https://ecuga.com/katalog",
    ]
    with sync_playwright() as p:
        ...
        page.goto(f"{bases[0]}/tequila", wait_until="domcontentloaded", timeout=60000)
