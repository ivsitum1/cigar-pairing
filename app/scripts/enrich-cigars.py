...
MAP = [
    ...
    ("new world dorado sampler", "cig-aj-fernandez-new-world-dorado-sampler"),
    ("new world sampler", "cig-aj-fernandez-new-world-sampler"),
    ("new world", "cig-aj-fernandez-new-world"),
    ("blend 15", "cig-aj-fernandez-blend-15"),
    ("last call", "cig-aj-fernandez-last-call"),
    ("enclave", "cig-aj-fernandez-aj-enclave"),
    ("bellas artes", "cig-aj-fernandez-bellas-artes"),
    ("dias de gloria", "cig-aj-fernandez-dias-de-gloria"),
    ("san lotano", "cig-aj-fernandez-aj-san-lotano"),
    ("ajf 20th anniversary", "cig-aj-fernandez-20th-anniversary"),
    ("aj fernandez premium sampler", "cig-aj-fernandez-premium-sampler"),
    ("aj fernandez toro sampler", "cig-aj-fernandez-toro-sampler"),
    ("liga privada", "cig-drew-estate-de-liga-privada"),
    ("undercrown", "cig-drew-estate-de-undercrown"),
    ("herrera esteli", "cig-drew-estate-de-herrera"),
    ...
    ("macanudo inspirado", "cig-macanudo-macanudo-inspirado"),
    ("macanudo cafe", "cig-macanudo-cafe"),
    ("charter oak", "cig-foundation-fnd-charter-oak"),
    ("kintsugi", "cig-alec-bradley-kintsugi"),
    ("rocky patel decade", "cig-rocky-patel-decade"),
    ("rocky patel sixty", "cig-rocky-patel-rp-sixty"),
    ("le bijou", "cig-my-father-le-bijou"),
    ("flor de las antillas", "cig-my-father-flor-antillas"),
    ("tatuaje fausto", "cig-tatuaje-tatuaje-fausto"),
