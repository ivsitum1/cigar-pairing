...
## Popis literature za kasniji grill (referenca, ne prepisivanje)
...
## Otvorena pitanja (backlog)

- Skuplja li se i **usmeno** (večeri, prijatelji) ili samo literatura?
- Treba li inbox kasnije imati EN stubove paralelno s grillom?
- Koje vignette su previše specifične za HR da bi bile univerzalne u app EN kopiji?
