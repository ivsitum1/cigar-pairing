---
source: K-Dense scientific-thinking-skills (MIT)
adapted_for: agent-rules workspace
note: Progressive disclosure; prefer PubMed MCP over embedding API keys in skills.
---
